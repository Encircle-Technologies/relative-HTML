...
module.exports = {
    ...
    theme: {
        fontFamily: {
            NordiquePro: ['Nordique Pro'],
            NordiqueProInline: ['Nordique Pro Inline'],
        },
        colors: {
        ...
        backgroundImage: theme => ({
            none: 'none',
            'bgradient': 'linear-gradient(180deg, rgba(6,201,183,1) 0%, rgba(1,144,167,1) 100%)',
        ...
        dropShadow: {
            'none': 'none',
            'f-card': '6px 8px 20px rgba(0, 0, 0, 0.2)',
            'menu': '0px 3px 6px rgba(0, 0, 0, 0.16)',
            'hp-btn': '3px 3px 4px rgba(235, 44, 91, 0.65)',
            'hb-btn': '3px 3px 4px rgba(38, 54, 128, 0.65)',
        },
        borderWidth: {
            1: '1px',
            2: '2px',
